...
function intFlash(elementId, msg, type) {
  ...
  el.innerHTML = `<div style="background:${bg};border:1px solid ${border};border-radius:6px;color:${color};font-size:12px;padding:6px 10px;margin-top:8px;">${escapeHtml(msg)}</div>`;
